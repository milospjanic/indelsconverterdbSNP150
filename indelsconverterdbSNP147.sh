...
awk 'NR==FNR {h1[$1] = $1; h2[$2]=$2; h3[$1$2]=$4; next} {if(h2[$2]==$2 && h1[$1]==$1 ) print h3[$1$2]"\t"$0}' snp150Common.bed.snp.plus.simple.deletions $SNPS.indel.short.2 > $1.rsID.nohead.snp.plus.simple.deletions
